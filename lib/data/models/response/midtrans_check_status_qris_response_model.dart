...
class MidtransCheckStatusQrisResponse {
  ...
  factory MidtransCheckStatusQrisResponse.fromJson(String str) => MidtransCheckStatusQrisResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory MidtransCheckStatusQrisResponse.fromMap(Map<String, dynamic> json) => MidtransCheckStatusQrisResponse(
