...
class MidtransQrisResponse {
  ...
  factory MidtransQrisResponse.fromJson(String str) => MidtransQrisResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory MidtransQrisResponse.fromMap(Map<String, dynamic> json) => MidtransQrisResponse(
