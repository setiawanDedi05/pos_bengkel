...
class CheckoutQrisDialog extends StatefulWidget {
  final OrderModel order;

  const CheckoutQrisDialog({required this.order, super.key});

  @override
  State<CheckoutQrisDialog> createState() => _CheckoutQrisDialogState();
}

class _CheckoutQrisDialogState extends State<CheckoutQrisDialog> {
  String orderId = '';
  Timer? timer;
  ...
  void initState() {
    ...
    context
        .read<QrisBloc>()
        .add(QrisEvent.generateQrCode(orderId, widget.order.totalPrice + widget.order.serviceFee));
    super.initState();
  }
                    ...
                    state.maybeWhen(
                        ...
                        success: (message) {
                          ...
                          handleProsses(
                            ...
                            nominal: widget.order.totalPrice,
