...
mixin _$DraftOrderState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<OrderModel> draftOrders) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<OrderModel> draftOrders)? success,
...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<OrderModel> draftOrders});
}
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(final List<OrderModel> draftOrders)
      : _draftOrders = draftOrders;

  final List<OrderModel> _draftOrders;
  @override
  List<OrderModel> get draftOrders {
...
abstract class _Success implements DraftOrderState {
  const factory _Success(final List<OrderModel> draftOrders) = _$SuccessImpl;
